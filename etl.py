from db_etl import DB

db_original = DB()
db_original.conectar_db("test_etl.db")

db_datawarehouse = DB()
db_datawarehouse.conectar_db("db_etl.db")
...
def actualizar_columnas_etl_db_original():
    ...
    db_original.actualizar_db(base_sql_entidades)
    db_original.actualizar_db(base_sql_espacios)
    db_original.actualizar_db(base_sql_representantes)
    db_original.actualizar_db(base_sql_muertes_subitas)
    db_original.actualizar_db(base_sql_inconvenientes)
    db_original.actualizar_db(base_sql_espacios_user)


class ETL:
    def actualizar_db_etl(self):
    ...
    def actualizar_db_sistema(self):
